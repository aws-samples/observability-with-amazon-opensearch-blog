...
curl -sSL https://raw.githubusercontent.com/aws-samples/observability-with-amazon-opensearch-blog/main/00-setup.sh | bash -s stable
source ~/.bash_profile
...
sed -i -e "s/__AOS_ENDPOINT__/$AOS_ENDPOINT/g" observability-with-amazon-opensearch-blog/sample-apps/01-data-prepper/kubernetes/data-prepper.yaml
sed -i -e "s/__AOS_USERNAME__/$AOS_USERNAME/g" observability-with-amazon-opensearch-blog/sample-apps/01-data-prepper/kubernetes/data-prepper.yaml
sed -i -e "s/__AOS_PASSWORD__/$AOS_PASSWORD/g" observability-with-amazon-opensearch-blog/sample-apps/01-data-prepper/kubernetes/data-prepper.yaml

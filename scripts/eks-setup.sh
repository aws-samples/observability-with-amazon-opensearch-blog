...
sed -i -e "s/__AOS_ENDPOINT__/$AOS_ENDPOINT/g" observability-with-amazon-opensearch-blog/sample-apps/01-data-preper/kubernetes/data-preper.yaml
sed -i -e "s/__AOS_USERNAME__/$AOS_USERNAME/g" observability-with-amazon-opensearch-blog/sample-apps/01-data-preper/kubernetes/data-preper.yaml
sed -i -e "s/__AOS_PASSWORD__/$AOS_PASSWORD/g" observability-with-amazon-opensearch-blog/sample-apps/01-data-preper/kubernetes/data-preper.yaml
